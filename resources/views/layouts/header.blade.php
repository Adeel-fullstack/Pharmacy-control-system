...
<head>
  ...
  <!-- Icons -->
  <link rel="stylesheet" href="{{ asset('vault/vuexy-bootstrap-html-admin-template/assets/vendor/fonts/fontawesome.css') }}" />
  ...
  <link rel="stylesheet" href="{{ asset('vault/assets/vendor/libs/datatables-responsive-bs5/responsive.bootstrap5.css') }}" />
  <link rel="stylesheet" href="{{ asset('vault/assets/vendor/libs/datatables-checkboxes-jquery/datatables.checkboxes.css') }}" />
          ...
          <div class="container-xxl">
            <div class="navbar-brand app-brand demo d-none d-xl-flex py-0 me-4">
              <a href="index.html" class="app-brand-link gap-2">
                ...
                <span class="app-brand-text demo menu-text fw-bold">Ahmad Wellness Pharmacy </span>
              </a>
                    ...
                    <div class="dropdown-shortcuts-list scrollable-container">
                      <div class="row row-bordered overflow-visible g-0">
                        <div class="dropdown-shortcuts-item col">
                          ...
                          <a href="{{ asset('vault/assets/app-calendar.html') }}" class="stretched-link">Calendar</a>
                        ...
                        <div class="dropdown-shortcuts-item col">
                          ...
                          <a href="{{ asset('vault/assets/app-invoice-list.html') }}" class="stretched-link">Invoice App</a>
                      ...
                      <div class="row row-bordered overflow-visible g-0">
                        <div class="dropdown-shortcuts-item col">
                          ...
                          <a href="{{ asset('vault/assets/app-user-list.html') }}" class="stretched-link">User App</a>
                        ...
                        <div class="dropdown-shortcuts-item col">
                          ...
                          <a href="{{ asset('vault/assets/app-access-roles.html') }}" class="stretched-link">Role Management</a>
                      ...
                      <div class="row row-bordered overflow-visible g-0">
                        <div class="dropdown-shortcuts-item col">
                          ...
                          <a href="{{ asset('vault/assets/index.html') }}" class="stretched-link">Dashboard</a>
                        ...
                        <div class="dropdown-shortcuts-item col">
                          ...
                          <a href="{{ asset('vault/assets/pages-account-settings-account.html') }}" class="stretched-link">Setting</a>
                      ...
                      <div class="row row-bordered overflow-visible g-0">
                        <div class="dropdown-shortcuts-item col">
                          ...
                          <a href="{{ asset('vault/assets/pages-help-center-landing.html') }}" class="stretched-link">Help Center</a>
                        ...
                        <div class="dropdown-shortcuts-item col">
                          ...
                          <a href="{{ asset('vault/assets/modal-examples.html') }}" class="stretched-link">Modals</a>
      ...
      <ul class="list-group list-group-flush">
        <li class="list-group-item list-group-item-action dropdown-notifications-item">
          <div class="d-flex">
            <div class="flex-shrink-0 me-3">
              <div class="avatar">
                <img src="{{ asset('storage/vault/assets/img/avatars/1.png') }}" alt class="h-auto rounded-circle" />
              </div>
            </div>
        ...
        <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
          <div class="d-flex">
            <div class="flex-shrink-0 me-3">
              <div class="avatar">
                <img src="{{ asset('vault/assets/img/avatars/2.png') }}" alt class="h-auto rounded-circle" />
              </div>
            </div>
            <div class="flex-grow-1">
        ...
        <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
          <div class="d-flex">
            <div class="flex-shrink-0 me-3">
              <div class="avatar">
                <img src="{{ asset('vault/assets/img/avatars/9.png') }}" alt class="h-auto rounded-circle" />
              </div>
            </div>
            <div class="flex-grow-1">
        ...
        <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
          <div class="d-flex">
            <div class="flex-shrink-0 me-3">
              <div class="avatar">
                <img src="{{ asset('vault/assets/img/avatars/5.png') }}" alt class="h-auto rounded-circle" />
              </div>
            </div>
            <div class="flex-grow-1">
        ...
        <li class="list-group-item list-group-item-action dropdown-notifications-item">
          <div class="d-flex">
            <div class="flex-shrink-0 me-3">
              <div class="avatar">
                <img src="{{ asset('vault/assets/img/avatars/6.png') }}" alt class="h-auto rounded-circle" />
              </div>
            </div>
            <div class="flex-grow-1">
...
<li class="nav-item navbar-dropdown dropdown-user dropdown">
  ...
  <ul class="dropdown-menu dropdown-menu-end">
    ...
    <li>
      <a class="dropdown-item" href="{{ asset('pages-profile-user.html') }}">
    ...
    <li>
      <a class="dropdown-item" href="{{ asset('pages-account-settings-billing.html') }}">
    ...
    <li>
      <a class="dropdown-item" href="{{ asset('pages-help-center-landing.html') }}">
        <i class="ti ti-lifebuoy me-2 ti-sm"></i>
        <span class="align-middle">Help</span>
      </a>
    </li>
    <li>
      <a class="dropdown-item" href="{{ asset('pages-faq.html') }}">
        <i class="ti ti-help me-2 ti-sm"></i>
        <span class="align-middle">FAQ</span>
      </a>
    </li>
    <li>
      <a class="dropdown-item" href="{{ asset('pages-pricing.html') }}">
    ...
    <li>
      <a class="dropdown-item" href="{{ asset('auth-login-cover.html') }}" target="_blank">
              ...
              <div class="container-xxl d-flex h-100">
                <ul class="menu-inner">
                    ...
                    <ul class="menu-sub">
                      <li class="menu-item">
                        <a href="layouts-without-menu.html" class="menu-link">
                          ...
                          <div data-i18n="New Stock">New Stock</div>
                        </a>
                      </li>
                      <li class="menu-item">
                      ...
                      <li class="menu-item">
                        <a href="../vertical-menu-template/" class="menu-link" target="_blank">
                          ...
                          <div data-i18n="Stock Required">Stock Required</div>
                        </a>
                      </li>
                      <li class="menu-item">
                        <a href="layouts-fluid.html" class="menu-link">
                          <i class="menu-icon tf-icons ti ti-maximize"></i>
                          <div data-i18n="Suggestion">Suggestion</div>
                        </a>
                      </li>
                    </ul> <!-- Close the Stock menu-sub here -->
                  </li> <!-- Make sure this li tag closes here for the Stock section -->
                    ...
                    <ul class="menu-sub">
                      ...
                      <li class="menu-item">
                        <a href="app-chat.html" class="menu-link">
                          ...
                          <div data-i18n="Today Sales">Today Sales</div>
                        </a>
                      </li>
                      <li class="menu-item">
                        <a href="app-calendar.html" class="menu-link">
                          <i class="menu-icon tf-icons ti ti-calendar"></i>
                          <div data-i18n="Sales History">Sales History</div>
                        </a>
                      </li>
                    </ul>
                  </li>
                  ...
                  <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                      <li class="menu-item">
                        <a href="new-employee.html" class="menu-link">
                  ...
                  <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                      <li class="menu-item">
                        <a href="new-customer.html" class="menu-link">
                          <i class="menu-icon tf-icons ti ti-user-plus"></i>
                          <div data-i18n="New Customer">New Customer</div>
                        </a>
                      </li>
                      <li class="menu-item">
                        <a href="all-customers.html" class="menu-link">
                          <i class="menu-icon tf-icons ti ti-list"></i>
